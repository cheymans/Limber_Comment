\subsection{Alternative two-point shear statistics; the mass aperture statistic and COSEBIs}
...
Figure~\ref{fig:xi_pm_K16}, however, using the standard first-order extended
