...
{\bf TBD: add figures of $P_\kappa$ and $\xi_\pm$ for all these combinations showing that they make absolutely no difference.}
 ...
 \begin{figure}
 \begin{center}
 \includegraphics[width=0.75\textwidth]{figures/Cl_xi_comp.pdf}
 \label{fig:Cl_xi}
 \caption{\emph{Upper Panels:} Theoretical models for the shear power spectrum (\emph{left}) and shear correlation function $\xi_+$ (\emph{right}) for the different approximations listed in Table~\ref{tab:Tl_nu}. \emph{Lower Panels:} Deviations with respect to the full treatment (ELS).}
 \end{center}
 \end{figure}
