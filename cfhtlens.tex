...
Monte-Carlo parameter sampling is performed using the publicly available
...
amplitude that is well within the Monte-Carlo sampling noise. \mk{This
negligible change relative to the error bars was to be expected owing to the
