...
\ch{This text taken from the comment on paper;
...
We need to take a decision here about what to use.  Do we need a Full Flat case in Table 1, and to demonstrate that Ext2Fl is very close to FullFl?  And then use Ext2Fl as our "truth" for the correlation function?}
