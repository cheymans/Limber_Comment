...
difference is measured with the \forref{deprecated} case ExtL1Fl, for which the
...
\begin{centering}
  ...
  \caption{\label{tab:CFHTLenS_Sigma8}Mean and 68\% \forref{credible} interval for 
