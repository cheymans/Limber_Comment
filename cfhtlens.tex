...
difference is measured with the deprecated case ExtL1Fl, for which the
...
(\Omega_{\rm m}/0.27)^{0.6} = 0.768^{+0.029}_{-0.031}$, using L1Fl.
...
\begin{centering}
  ...
  \caption{\label{tab:CFHTLenS_Sigma8}Mean and 68\% credible interval for 
  ...
  ExtL2Sph(Hankel) & $0.789^{+0.031}_{-0.032}$ & $0.740^{+0.029}_{-0.030}$ \\ \hline
  \end{tabular}
