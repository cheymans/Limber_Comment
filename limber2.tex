...
redshift distribution $n_z(z) {\rm d}z = n(\chi) {\rm d} \chi$, \mk{with limit the
comoving distance to the horizon $\chi_{\rm h}$.} Here, ${\rm c}$ is the speed
...
constant, $\vec k$ a 3D Fourier wave vector \mk{with modulus $k$ being the comoving
