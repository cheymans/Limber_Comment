...
\forref{We note that in all cases the second-order Limber expansion adds power
...
estimation of the reduced Wigner ${\rm D}$-matrices ${\rm d}^\ell_{22}$ and
...
%
\left[ \left( {\rm d}^1_{00}-{mn\over \ell(\ell-1)} \right) {\rm d}^{\ell-1}_{mn}
%
-{\sqrt{[(\ell-1)^2-m^2][(\ell-1)^2-n^2]}\over (\ell-1)(2\ell-1)} {\rm d}^{\ell-2}_{mn}\right] ,
%
\end{equation}
%
