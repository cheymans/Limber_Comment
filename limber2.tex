...
using the harmonics expansion of the shear (equation~\ref{eq:gamma_harm_exp}) and the orthogonality relation of
...
spherical transform (equation~\ref{eq:xi_Legendre}) is well below one percent
...
\EDIT{Note: The factor of $a^2$ has been resolved, it is correctly reproduced
when propagating the primordial potential power spectrum to late times $a$
with $[D+(a)/a]^2$ instead of $D^2+(a)$.}
