...
redshift distribution $n_z(z) {\rm d}z = n(\chi) {\rm d} \chi$, with the limit being the
...
\citep{FSHK08}. Here we examine the effect of sky curvature on the theoretical
models of the power spectrum, and the effect on cosmological parameter
inference (see Sect.~\ref{sec:cfhtlens}).
