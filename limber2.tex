...
references therein]{miraldaescude:1991, kaiser:1992, BS01}.
...
$W_\kappa[z(\chi)] = H(z)^{-1} \chi q(\chi)$, we
%
%\begin{align}
...
%%
%We
recover our (\ref{eq:P_ell_gamma}).
...
missing $r_K[r] r_K[r^\prime]$ in the full projection integral\footnote{Typo confirmed by T.~G.,
priv.~comm.}. This also leads to an errorous $r_K^{-2}(r)$ in the Limber
equation (27). With these factors accounted for, we reproduce the expressions
of \cite{2012MNRAS.422.2854G}.
